...
import 'deliver_page_model.dart';
export 'deliver_page_model.dart';

class DeliverPageWidget extends StatefulWidget {
  const DeliverPageWidget({super.key});

  @override
  State<DeliverPageWidget> createState() => _DeliverPageWidgetState();
}

class _DeliverPageWidgetState extends State<DeliverPageWidget> {
  late DeliverPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeliverPageModel());
